...
pub const ACRN_IOCTL_ASSIGN_MMIODEV: u32 = 2154340951;
pub const ACRN_IOCTL_DEASSIGN_MMIODEV: u32 = 2154340952;
pub const ACRN_IOCTL_CREATE_VDEV: u32 = 2160108121;
pub const ACRN_IOCTL_DESTROY_VDEV: u32 = 2160108122;
...
pub const AGPIOC_INFO: u32 = 1074282752;
pub const AGPIOC_ACQUIRE: u32 = 536887553;
pub const AGPIOC_RELEASE: u32 = 536887554;
pub const AGPIOC_SETUP: u32 = 2148024579;
pub const AGPIOC_RESERVE: u32 = 2148024580;
pub const AGPIOC_PROTECT: u32 = 2148024581;
pub const AGPIOC_ALLOCATE: u32 = 3221766406;
pub const AGPIOC_DEALLOCATE: u32 = 2147762439;
pub const AGPIOC_BIND: u32 = 2148024584;
pub const AGPIOC_UNBIND: u32 = 2148024585;
pub const AGPIOC_CHIPSET_FLUSH: u32 = 536887562;
...
pub const VIDIOC_REMOVE_BUFS: u32 = 3225441896;
...
pub const SIOCINQ: u32 = 1074030207;
pub const SIOCOUTQ: u32 = 1074033779;
...
pub const HCIDEVUP: u32 = 2147764425;
pub const HCIDEVDOWN: u32 = 2147764426;
pub const HCIDEVRESET: u32 = 2147764427;
pub const HCIDEVRESTAT: u32 = 2147764428;
pub const HCIGETDEVLIST: u32 = 1074022610;
pub const HCIGETDEVINFO: u32 = 1074022611;
pub const HCIGETCONNLIST: u32 = 1074022612;
pub const HCIGETCONNINFO: u32 = 1074022613;
pub const HCIGETAUTHINFO: u32 = 1074022615;
pub const HCISETRAW: u32 = 2147764444;
pub const HCISETSCAN: u32 = 2147764445;
pub const HCISETAUTH: u32 = 2147764446;
pub const HCISETENCRYPT: u32 = 2147764447;
pub const HCISETPTYPE: u32 = 2147764448;
pub const HCISETLINKPOL: u32 = 2147764449;
pub const HCISETLINKMODE: u32 = 2147764450;
pub const HCISETACLMTU: u32 = 2147764451;
pub const HCISETSCOMTU: u32 = 2147764452;
pub const HCIBLOCKADDR: u32 = 2147764454;
pub const HCIUNBLOCKADDR: u32 = 2147764455;
pub const HCIINQUIRY: u32 = 1074022640;
pub const RFCOMMCREATEDEV: u32 = 2147766984;
pub const RFCOMMRELEASEDEV: u32 = 2147766985;
pub const RFCOMMGETDEVLIST: u32 = 1074025170;
pub const RFCOMMGETDEVINFO: u32 = 1074025171;
pub const RFCOMMSTEALDLC: u32 = 2147767004;
pub const BNEPCONNADD: u32 = 2147762888;
pub const BNEPCONNDEL: u32 = 2147762889;
pub const BNEPGETCONNLIST: u32 = 1074021074;
pub const BNEPGETCONNINFO: u32 = 1074021075;
pub const BNEPGETSUPPFEAT: u32 = 1074021076;
pub const CMTPCONNADD: u32 = 2147763144;
pub const CMTPCONNDEL: u32 = 2147763145;
pub const CMTPGETCONNLIST: u32 = 1074021330;
pub const CMTPGETCONNINFO: u32 = 1074021331;
pub const HIDPCONNADD: u32 = 2147764424;
pub const HIDPCONNDEL: u32 = 2147764425;
pub const HIDPGETCONNLIST: u32 = 1074022610;
pub const HIDPGETCONNINFO: u32 = 1074022611;
...
pub const FS_IOC_GETFSUUID: u32 = 1074861312;
pub const FS_IOC_GETFSSYSFSPATH: u32 = 1082201345;
pub const FS_IOC_GETLBMD_CAP: u32 = 3222279426;
pub const PAGEMAP_SCAN: u32 = 3227543056;
pub const PROCMAP_QUERY: u32 = 3228067345;
...
pub const BTRFS_IOC_GET_FSLABEL: u32 = 1090556977;
pub const BTRFS_IOC_SET_FSLABEL: u32 = 2164298802;
...
pub const BTRFS_IOC_ENCODED_READ: u32 = 1082168384;
pub const BTRFS_IOC_ENCODED_WRITE: u32 = 2155910208;
pub const BTRFS_IOC_SUBVOL_SYNC_WAIT: u32 = 2148570177;
...
pub const DMA_BUF_IOCTL_EXPORT_SYNC_FILE: u32 = 3221774850;
pub const DMA_BUF_IOCTL_IMPORT_SYNC_FILE: u32 = 2148033027;
...
pub const DM_MPATH_PROBE_PATHS: u32 = 536935698;
pub const EPIOCSPARAMS: u32 = 2148043265;
pub const EPIOCGPARAMS: u32 = 1074301442;
...
pub const F2FS_IOC_ABORT_ATOMIC_WRITE: u32 = 536933637;
...
pub const F2FS_IOC_START_ATOMIC_REPLACE: u32 = 536933657;
pub const F2FS_IOC_GET_DEV_ALIAS_FILE: u32 = 1074066714;
pub const F2FS_IOC_IO_PRIO: u32 = 2147808539;
...
pub const FDSETMEDIAPRM: u32 = 2149581378;
pub const FDDEFPRM: u32 = 2149581379;
pub const FDGETPRM: u32 = 1075839492;
pub const FDDEFMEDIAPRM: u32 = 2149581379;
pub const FDGETMEDIAPRM: u32 = 1075839492;
...
pub const FSI_SBEFIFO_CMD_TIMEOUT_SECONDS: u32 = 2147775233;
pub const FSI_SBEFIFO_READ_TIMEOUT_SECONDS: u32 = 2147775232;
...
pub const FUSE_DEV_IOC_BACKING_OPEN: u32 = 2148590849;
pub const FUSE_DEV_IOC_BACKING_CLOSE: u32 = 2147804418;
...
pub const GSMIOC_GETCONF_EXT: u32 = 1075857157;
pub const GSMIOC_SETCONF_EXT: u32 = 2149598982;
pub const GSMIOC_GETCONF_DLCI: u32 = 3224913671;
pub const GSMIOC_SETCONF_DLCI: u32 = 2151171848;
...
pub const HIDIOCREVOKE: u32 = 2147764237;
...
pub const I8K_BIOS_VERSION: u32 = 1074030976;
pub const I8K_MACHINE_ID: u32 = 1074030977;
pub const I8K_POWER_STATUS: u32 = 1074293122;
pub const I8K_FN_STATUS: u32 = 1074293123;
pub const I8K_GET_TEMP: u32 = 1074293124;
...
pub const ISST_IF_COUNT_TPMI_INSTANCES: u32 = 1074331141;
pub const ISST_IF_CORE_POWER_STATE: u32 = 3221814790;
pub const ISST_IF_CLOS_PARAM: u32 = 3221814791;
pub const ISST_IF_CLOS_ASSOC: u32 = 3221814792;
pub const ISST_IF_PERF_LEVELS: u32 = 3221814793;
pub const ISST_IF_PERF_SET_LEVEL: u32 = 2148072970;
pub const ISST_IF_PERF_SET_FEATURE: u32 = 2148072971;
pub const ISST_IF_GET_PERF_LEVEL_INFO: u32 = 1074331148;
pub const ISST_IF_GET_PERF_LEVEL_CPU_MASK: u32 = 1074331149;
pub const ISST_IF_GET_BASE_FREQ_INFO: u32 = 1074331150;
pub const ISST_IF_GET_BASE_FREQ_CPU_MASK: u32 = 1074331151;
pub const ISST_IF_GET_TURBO_FREQ_INFO: u32 = 1074331152;
pub const ISST_IF_GET_PERF_LEVEL_FABRIC_INFO: u32 = 1074331153;
...
pub const KDMAPDISP: u32 = 19260;
pub const KDUNMAPDISP: u32 = 19261;
...
pub const KDSKBDIACR: u32 = 19275;
pub const KDGKBDIACRUC: u32 = 19450;
pub const KDSKBDIACRUC: u32 = 19451;
pub const KDGETKEYCODE: u32 = 19276;
pub const KDSETKEYCODE: u32 = 19277;
pub const KDSIGACCEPT: u32 = 19278;
pub const KDKBDREP: u32 = 19282;
pub const KDFONTOP: u32 = 19314;
...
pub const MEDIA_IOC_REQUEST_ALLOC: u32 = 1074035717;
...
pub const NS_GET_MNTNS_ID: u32 = 1074312965;
pub const NS_GET_PID_FROM_PIDNS: u32 = 1074050822;
pub const NS_GET_TGID_FROM_PIDNS: u32 = 1074050823;
pub const NS_GET_PID_IN_PIDNS: u32 = 1074050824;
pub const NS_GET_TGID_IN_PIDNS: u32 = 1074050825;
pub const NS_MNT_GET_INFO: u32 = 1074837258;
pub const NS_MNT_GET_NEXT: u32 = 1074837259;
pub const NS_MNT_GET_PREV: u32 = 1074837260;
...
pub const NVME_IOCTL_IO64_CMD_VEC: u32 = 3226488393;
pub const NVME_URING_CMD_IO: u32 = 3225964160;
pub const NVME_URING_CMD_IO_VEC: u32 = 3225964161;
pub const NVME_URING_CMD_ADMIN: u32 = 3225964162;
pub const NVME_URING_CMD_ADMIN_VEC: u32 = 3225964163;
...
pub const PCITEST_INTX_IRQ: u32 = 536891394;
...
pub const PCITEST_BARS: u32 = 536891402;
pub const PCITEST_DOORBELL: u32 = 536891403;
...
pub const SIOCGPPPSTATS: u32 = 35312;
pub const SIOCGPPPVER: u32 = 35313;
pub const SIOCGPPPCSTATS: u32 = 35314;
...
pub const PTP_MASK_CLEAR_ALL: u32 = 536886547;
pub const PTP_MASK_EN_SINGLE: u32 = 2147761428;
...
pub const RFKILL_IOCTL_MAX_SIZE: u32 = 2147766786;
...
pub const RPMSG_CREATE_DEV_IOCTL: u32 = 2150151427;
pub const RPMSG_RELEASE_DEV_IOCTL: u32 = 2150151428;
pub const RPMSG_GET_OUTGOING_FLOWCONTROL: u32 = 1074050309;
pub const RPMSG_SET_INCOMING_FLOWCONTROL: u32 = 1074050310;
...
pub const RTC_PARAM_GET: u32 = 2149085203;
pub const RTC_PARAM_SET: u32 = 2149085204;
...
pub const IOC_OPAL_GET_STATUS: u32 = 1074295020;
pub const IOC_OPAL_GET_LR_STATUS: u32 = 2167435501;
pub const IOC_OPAL_GET_GEOMETRY: u32 = 1075867886;
pub const IOC_OPAL_DISCOVERY: u32 = 2148561135;
pub const IOC_OPAL_REVERT_LSP: u32 = 2165338352;
pub const IOC_OPAL_SET_SID_PW: u32 = 2183164145;
...
pub const SNDRV_HWDEP_IOCTL_PVERSION: u32 = 1074022400;
pub const SNDRV_HWDEP_IOCTL_INFO: u32 = 1088178177;
pub const SNDRV_HWDEP_IOCTL_DSP_STATUS: u32 = 1077954562;
pub const SNDRV_HWDEP_IOCTL_DSP_LOAD: u32 = 2153793539;
pub const SNDRV_PCM_IOCTL_PVERSION: u32 = 1074020608;
pub const SNDRV_PCM_IOCTL_INFO: u32 = 1092632833;
pub const SNDRV_PCM_IOCTL_TSTAMP: u32 = 2147762434;
pub const SNDRV_PCM_IOCTL_TTSTAMP: u32 = 2147762435;
pub const SNDRV_PCM_IOCTL_USER_PVERSION: u32 = 2147762436;
pub const SNDRV_PCM_IOCTL_HW_REFINE: u32 = 3261088016;
pub const SNDRV_PCM_IOCTL_HW_PARAMS: u32 = 3261088017;
pub const SNDRV_PCM_IOCTL_HW_FREE: u32 = 536887570;
pub const SNDRV_PCM_IOCTL_SW_PARAMS: u32 = 3230155027;
pub const SNDRV_PCM_IOCTL_STATUS: u32 = 1083719968;
pub const SNDRV_PCM_IOCTL_DELAY: u32 = 1074282785;
pub const SNDRV_PCM_IOCTL_HWSYNC: u32 = 536887586;
pub const __SNDRV_PCM_IOCTL_SYNC_PTR: u32 = 3230155043;
pub const __SNDRV_PCM_IOCTL_SYNC_PTR64: u32 = 3230155043;
pub const SNDRV_PCM_IOCTL_SYNC_PTR: u32 = 3230155043;
pub const SNDRV_PCM_IOCTL_STATUS_EXT: u32 = 3231203620;
pub const SNDRV_PCM_IOCTL_CHANNEL_INFO: u32 = 1075331378;
pub const SNDRV_PCM_IOCTL_PREPARE: u32 = 536887616;
pub const SNDRV_PCM_IOCTL_RESET: u32 = 536887617;
pub const SNDRV_PCM_IOCTL_START: u32 = 536887618;
pub const SNDRV_PCM_IOCTL_DROP: u32 = 536887619;
pub const SNDRV_PCM_IOCTL_DRAIN: u32 = 536887620;
pub const SNDRV_PCM_IOCTL_PAUSE: u32 = 2147762501;
pub const SNDRV_PCM_IOCTL_REWIND: u32 = 2148024646;
pub const SNDRV_PCM_IOCTL_RESUME: u32 = 536887623;
pub const SNDRV_PCM_IOCTL_XRUN: u32 = 536887624;
pub const SNDRV_PCM_IOCTL_FORWARD: u32 = 2148024649;
pub const SNDRV_PCM_IOCTL_WRITEI_FRAMES: u32 = 2149073232;
pub const SNDRV_PCM_IOCTL_READI_FRAMES: u32 = 1075331409;
pub const SNDRV_PCM_IOCTL_WRITEN_FRAMES: u32 = 2149073234;
pub const SNDRV_PCM_IOCTL_READN_FRAMES: u32 = 1075331411;
pub const SNDRV_PCM_IOCTL_LINK: u32 = 2147762528;
pub const SNDRV_PCM_IOCTL_UNLINK: u32 = 536887649;
pub const SNDRV_RAWMIDI_IOCTL_PVERSION: u32 = 1074026240;
pub const SNDRV_RAWMIDI_IOCTL_INFO: u32 = 1091327745;
pub const SNDRV_RAWMIDI_IOCTL_USER_PVERSION: u32 = 2147768066;
pub const SNDRV_RAWMIDI_IOCTL_PARAMS: u32 = 3224393488;
pub const SNDRV_RAWMIDI_IOCTL_STATUS: u32 = 3224917792;
pub const SNDRV_RAWMIDI_IOCTL_DROP: u32 = 2147768112;
pub const SNDRV_RAWMIDI_IOCTL_DRAIN: u32 = 2147768113;
pub const SNDRV_UMP_IOCTL_ENDPOINT_INFO: u32 = 1095259968;
pub const SNDRV_UMP_IOCTL_BLOCK_INFO: u32 = 1085560641;
pub const SNDRV_TIMER_IOCTL_PVERSION: u32 = 1074025472;
pub const SNDRV_TIMER_IOCTL_NEXT_DEVICE: u32 = 3222557697;
pub const SNDRV_TIMER_IOCTL_TREAD_OLD: u32 = 2147767298;
pub const SNDRV_TIMER_IOCTL_GINFO: u32 = 3237499907;
pub const SNDRV_TIMER_IOCTL_GPARAMS: u32 = 2152223748;
pub const SNDRV_TIMER_IOCTL_GSTATUS: u32 = 3226489861;
pub const SNDRV_TIMER_IOCTL_SELECT: u32 = 2150913040;
pub const SNDRV_TIMER_IOCTL_INFO: u32 = 1088967697;
pub const SNDRV_TIMER_IOCTL_PARAMS: u32 = 2152748050;
pub const SNDRV_TIMER_IOCTL_STATUS: u32 = 1080054804;
pub const SNDRV_TIMER_IOCTL_START: u32 = 536892576;
pub const SNDRV_TIMER_IOCTL_STOP: u32 = 536892577;
pub const SNDRV_TIMER_IOCTL_CONTINUE: u32 = 536892578;
pub const SNDRV_TIMER_IOCTL_PAUSE: u32 = 536892579;
pub const SNDRV_TIMER_IOCTL_TREAD64: u32 = 2147767460;
pub const SNDRV_TIMER_IOCTL_CREATE: u32 = 3223344293;
pub const SNDRV_TIMER_IOCTL_TRIGGER: u32 = 536892582;
pub const SNDRV_TIMER_IOCTL_TREAD: u32 = 2147767298;
pub const SNDRV_CTL_IOCTL_PVERSION: u32 = 1074025728;
pub const SNDRV_CTL_IOCTL_CARD_INFO: u32 = 1098405121;
pub const SNDRV_CTL_IOCTL_ELEM_LIST: u32 = 3226490128;
pub const SNDRV_CTL_IOCTL_ELEM_INFO: u32 = 3239073041;
pub const SNDRV_CTL_IOCTL_ELEM_READ: u32 = 3301463314;
pub const SNDRV_CTL_IOCTL_ELEM_WRITE: u32 = 3301463315;
pub const SNDRV_CTL_IOCTL_ELEM_LOCK: u32 = 2151699732;
pub const SNDRV_CTL_IOCTL_ELEM_UNLOCK: u32 = 2151699733;
pub const SNDRV_CTL_IOCTL_SUBSCRIBE_EVENTS: u32 = 3221509398;
pub const SNDRV_CTL_IOCTL_ELEM_ADD: u32 = 3239073047;
pub const SNDRV_CTL_IOCTL_ELEM_REPLACE: u32 = 3239073048;
pub const SNDRV_CTL_IOCTL_ELEM_REMOVE: u32 = 3225441561;
pub const SNDRV_CTL_IOCTL_TLV_READ: u32 = 3221771546;
pub const SNDRV_CTL_IOCTL_TLV_WRITE: u32 = 3221771547;
pub const SNDRV_CTL_IOCTL_TLV_COMMAND: u32 = 3221771548;
pub const SNDRV_CTL_IOCTL_HWDEP_NEXT_DEVICE: u32 = 3221509408;
pub const SNDRV_CTL_IOCTL_HWDEP_INFO: u32 = 1088181537;
pub const SNDRV_CTL_IOCTL_PCM_NEXT_DEVICE: u32 = 1074025776;
pub const SNDRV_CTL_IOCTL_PCM_INFO: u32 = 3240121649;
pub const SNDRV_CTL_IOCTL_PCM_PREFER_SUBDEVICE: u32 = 2147767602;
pub const SNDRV_CTL_IOCTL_RAWMIDI_NEXT_DEVICE: u32 = 3221509440;
pub const SNDRV_CTL_IOCTL_RAWMIDI_INFO: u32 = 3238810945;
pub const SNDRV_CTL_IOCTL_RAWMIDI_PREFER_SUBDEVICE: u32 = 2147767618;
pub const SNDRV_CTL_IOCTL_UMP_NEXT_DEVICE: u32 = 3221509443;
pub const SNDRV_CTL_IOCTL_UMP_ENDPOINT_INFO: u32 = 3242743108;
pub const SNDRV_CTL_IOCTL_UMP_BLOCK_INFO: u32 = 3233043781;
pub const SNDRV_CTL_IOCTL_POWER: u32 = 3221509584;
pub const SNDRV_CTL_IOCTL_POWER_STATE: u32 = 1074025937;
...
pub const SYNC_IOC_SET_DEADLINE: u32 = 2148548101;
...
pub const TCGETA: u32 = 1074942977;
pub const TCSETA: u32 = 2148684802;
pub const TCSETAW: u32 = 2148684803;
pub const TCSETAF: u32 = 2148684804;
pub const TCSBRK: u32 = 536892421;
pub const TCXONC: u32 = 536892422;
pub const TCFLSH: u32 = 536892423;
pub const TCGETS: u32 = 1076122632;
pub const TCSETS: u32 = 2149864457;
pub const TCSETSW: u32 = 2149864458;
pub const TCSETSF: u32 = 2149864459;
pub const TCGETS2: u32 = 1076646924;
pub const TCSETS2: u32 = 2150388749;
pub const TCSETSW2: u32 = 2150388750;
pub const TCSETSF2: u32 = 2150388751;
pub const TIOCGDEV: u32 = 1074025522;
pub const TIOCVHANGUP: u32 = 536892471;
pub const TIOCGPKT: u32 = 1074025528;
pub const TIOCGPTLCK: u32 = 1074025529;
pub const TIOCGEXCL: u32 = 1074025536;
pub const TIOCGETD: u32 = 1074033664;
pub const TIOCSETD: u32 = 2147775489;
pub const __TIOCHPCL: u32 = 536900610;
pub const __TIOCMODG: u32 = 1074033667;
pub const __TIOCMODS: u32 = 2147775492;
pub const TIOCEXCL: u32 = 536900621;
pub const TIOCNXCL: u32 = 536900622;
pub const __TIOCFLUSH: u32 = 2147775504;
pub const __TIOCTCNTL: u32 = 2147775520;
pub const __TIOCSIGNAL: u32 = 2147775521;
pub const __TIOCSETX: u32 = 2147775522;
pub const __TIOCGETX: u32 = 1074033699;
pub const TIOCCONS: u32 = 536900644;
pub const TIOCGSOFTCAR: u32 = 1074033764;
pub const TIOCSSOFTCAR: u32 = 2147775589;
pub const __TIOCUCNTL: u32 = 2147775590;
pub const TIOCSWINSZ: u32 = 2148037735;
pub const TIOCGWINSZ: u32 = 1074295912;
pub const __TIOCREMOTE: u32 = 2147775593;
pub const TIOCMGET: u32 = 1074033770;
pub const TIOCMBIC: u32 = 2147775595;
pub const TIOCMBIS: u32 = 2147775596;
pub const TIOCMSET: u32 = 2147775597;
pub const TIOCSTART: u32 = 536900718;
pub const TIOCSTOP: u32 = 536900719;
pub const TIOCPKT: u32 = 2147775600;
pub const TIOCNOTTY: u32 = 536900721;
pub const TIOCSTI: u32 = 2147578994;
pub const TIOCOUTQ: u32 = 1074033779;
pub const __TIOCCDTR: u32 = 536900728;
pub const __TIOCSDTR: u32 = 536900729;
pub const TIOCCBRK: u32 = 536900730;
pub const TIOCSBRK: u32 = 536900731;
pub const __TIOCLGET: u32 = 2147775612;
pub const __TIOCLSET: u32 = 2147775613;
pub const __TIOCLBIC: u32 = 2147775614;
pub const __TIOCLBIS: u32 = 2147775615;
pub const __TIOCISPACE: u32 = 1074033792;
pub const __TIOCISIZE: u32 = 1074033793;
pub const TIOCSPGRP: u32 = 2147775618;
pub const TIOCGPGRP: u32 = 1074033795;
pub const TIOCSCTTY: u32 = 536900740;
pub const TIOCGSID: u32 = 1074033797;
pub const TIOCGPTN: u32 = 1074033798;
pub const TIOCSPTLCK: u32 = 2147775623;
pub const TIOCSIG: u32 = 2147775624;
pub const TIOCGPTPEER: u32 = 536900745;
...
pub const __TCGETSTAT: u32 = 536892616;
pub const __TCSETSTAT: u32 = 536892617;
...
pub const USERFAULTFD_IOC_NEW: u32 = 536914432;
...
pub const VIDIOC_SUBDEV_G_ROUTING: u32 = 3225441830;
pub const VIDIOC_SUBDEV_S_ROUTING: u32 = 3225441831;
pub const VIDIOC_SUBDEV_G_CLIENT_CAP: u32 = 1074288229;
...
pub const VDUSE_IOTLB_REG_UMEM: u32 = 2150662424;
pub const VDUSE_IOTLB_DEREG_UMEM: u32 = 2150662425;
pub const VDUSE_IOTLB_GET_INFO: u32 = 3224404250;
...
pub const VFIO_DEVICE_BIND_IOMMUFD: u32 = 536886134;
pub const VFIO_DEVICE_ATTACH_IOMMUFD_PT: u32 = 536886135;
pub const VFIO_DEVICE_DETACH_IOMMUFD_PT: u32 = 536886136;
pub const VFIO_MIG_GET_PRECOPY_INFO: u32 = 536886137;
...
pub const VHOST_NEW_WORKER: u32 = 1074048776;
pub const VHOST_FREE_WORKER: u32 = 2147790601;
...
pub const VHOST_ATTACH_VRING_WORKER: u32 = 2148052757;
pub const VHOST_GET_VRING_WORKER: u32 = 3221794582;
...
pub const VHOST_VDPA_GET_CONFIG_SIZE: u32 = 1074048889;
pub const VHOST_VDPA_GET_AS_NUM: u32 = 1074048890;
pub const VHOST_VDPA_GET_VRING_GROUP: u32 = 3221794683;
pub const VHOST_VDPA_SET_GROUP_ASID: u32 = 2148052860;
pub const VHOST_VDPA_SUSPEND: u32 = 536915837;
pub const VHOST_VDPA_RESUME: u32 = 536915838;
pub const VHOST_VDPA_GET_VRING_DESC_GROUP: u32 = 3221794687;
pub const VHOST_VDPA_GET_VQS_COUNT: u32 = 1074048896;
pub const VHOST_VDPA_GET_GROUP_NUM: u32 = 1074048897;
pub const VHOST_VDPA_GET_VRING_SIZE: u32 = 3221794690;
pub const VHOST_GET_FEATURES_ARRAY: u32 = 1074311043;
pub const VHOST_SET_FEATURES_ARRAY: u32 = 2148052867;
pub const VHOST_SET_FORK_FROM_OWNER: u32 = 2147594116;
pub const VHOST_GET_FORK_FROM_OWNER: u32 = 1073852293;
...
pub const VT_GETCONSIZECSRPOS: u32 = 1074288144;
